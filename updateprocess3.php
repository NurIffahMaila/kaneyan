...
<a href="index3.php">List Provinsi</a>
</div>
<?php
include_once 'connect.php';
if(count($_POST)>0) {
mysqli_query($host,"UPDATE provinsi set nama_provinsi='" . $_POST['nama_provinsi'] .  "' WHERE id_provinsi='" . $_POST['id_provinsi'] . "'");
$message = "Record Modified Successfully";
header("location:update3.php");
}
$result = mysqli_query($host,"SELECT * FROM provinsi WHERE id_provinsi='" . $_GET['id_provinsi'] . "'");
$row= mysqli_fetch_array($result);
?><br>
No: <br>
<input type="text" name="id_provinsi"  value="<?php echo $row['id_provinsi']; ?>">
<br>
Nama provinsi: <br>
<input type="text" name="nama_provinsi" class="txtField" value="<?php echo $row['nama_provinsi']; ?>">
<br>
