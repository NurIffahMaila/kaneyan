...
<a href="add3.php">Kembali</a>
</div>
<?php
include_once 'connect.php';
$result = mysqli_query($host,"SELECT * FROM provinsi");
?>
<?php
...
<table>
	  ...
	  <tr>
		...
		<td><a href="updateprocess3.php?id_provinsi=<?php echo $row["id_provinsi"]; ?>">Update</a></td>
        <td><a href="deleteprocess3.php?id_provinsi=<?php echo $row["id_provinsi"]; ?>">Delete</a></td>
      </tr>
            <?php
			$i++;
			}
