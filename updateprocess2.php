...
<a href="index2.php">List Komoditas</a>
</div>
<?php
include_once 'connect.php';
if(count($_POST)>0) {
mysqli_query($host,"UPDATE komoditas set nama_komoditas='" . $_POST['nama_komoditas'] . "', tanggal='" . $_POST['tanggal'] . "', harga_komoditas='" . $_POST['harga_komoditas'] .  "' WHERE id_komoditas='" . $_POST['id_komoditas'] . "'");
$message = "Record Modified Successfully";
header("location:update2.php");
}
$result = mysqli_query($host,"SELECT * FROM komoditas WHERE id_komoditas='" . $_GET['id_komoditas'] . "'");
$row= mysqli_fetch_array($result);
?><br>
No: <br>
<input type="text" name="id_komoditas"  value="<?php echo $row['id_komoditas']; ?>">
<br>
Nama komoditas: <br>
<input type="text" name="nama_komoditas" class="txtField" value="<?php echo $row['nama_komoditas']; ?>">
<br>
Tanggal: <br>
<input type="date" name="tanggal" class="txtField" value="<?php echo $row['tanggal']; ?>">
<br>
Harga komoditas: <br>
<input type="text" name="harga_komoditas" class="txtField" value="<?php echo $row['harga_komoditas']; ?>">
<br>
